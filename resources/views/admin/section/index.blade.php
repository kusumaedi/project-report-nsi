        ...
        <div class="col-auto ms-auto d-print-none">
          <div class="d-flex">
            <ol class="breadcrumb breadcrumb-arrows" aria-label="breadcrumbs">
              ...
              <li class="breadcrumb-item active" aria-current="page"><a href="#">Section</a></li>
            </ol>
          </div>
        </div>
      </div>
            ...
            <table class="table table-bordered table-striped" id="MyTable">
                ...
                @foreach ($section as $list)
                    <tr>
                        ...
                        <td>
                            <div class="d-inline">
                                <a href="{{ route('section.edit', $list->id) }}" class="btn btn-info btn-icon">
                            ...
                            <form action="{{ route('section.destroy', $list->id) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
