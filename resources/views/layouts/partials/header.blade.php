        ...
        <div class="navbar">
            <div class="container-xl">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item {{ request()->is('approver*') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('report.approver') }}">
                            <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                                <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-checklist"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9.615 20h-2.615a2 2 0 0 1 -2 -2v-12a2 2 0 0 1 2 -2h8a2 2 0 0 1 2 2v8" /><path d="M14 19l2 2l4 -4" /><path d="M9 8h4" /><path d="M9 12h2" /></svg>
                            </span>
                            <span class="nav-link-title">
                                Approval @if ($approver_notif > 0) <span class="badge bg-red text-red-fg badge-pill">{{ $approver_notif }}</span> @endif
                            </span>
                        </a>
                    </li>
                    @endif
                    ...
                    <li class="nav-item {{ request()->is('reviewer*') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('report.reviewer') }}">
                            <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                                <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-checklist"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9.615 20h-2.615a2 2 0 0 1 -2 -2v-12a2 2 0 0 1 2 -2h8a2 2 0 0 1 2 2v8" /><path d="M14 19l2 2l4 -4" /><path d="M9 8h4" /><path d="M9 12h2" /></svg>
                            </span>
                            <span class="nav-link-title">
                                Review @if ($reviewer_notif > 0) <span class="badge bg-red text-red-fg badge-pill">{{ $reviewer_notif }}</span> @endif
                            </span>
                        </a>
                    </li>
                    @endif
                    ...
                    <li class="nav-item dropdown {{ request()->is('master*') ? 'active' : '' }}">
                        <a class="nav-link dropdown-toggle" href="#navbar-help" data-bs-toggle="dropdown" data-bs-auto-close="outside" role="button" aria-expanded="false">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M12 6m-8 0a8 3 0 1 0 16 0a8 3 0 1 0 -16 0"></path><path d="M4 6v6a8 3 0 0 0 16 0v-6"></path><path d="M4 12v6a8 3 0 0 0 16 0v-6"></path>
                                </svg>
                            </span>
                            <span class="nav-link-title">
                                Master Data
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item {{ (request()->is('master/department')) ? 'active' : '' }}" href="{{ url('master/department') }}" rel="noopener">
                                Department
                            </a>
                            <a class="dropdown-item {{ (request()->is('master/section')) ? 'active' : '' }}" href="{{ url('master/section') }}" rel="noopener">
                                Section
                            </a>
                        </div>
                    </li>
